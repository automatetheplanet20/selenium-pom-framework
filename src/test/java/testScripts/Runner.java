...
public class Runner {
	...
	public static void main(String[] args) {
		...
		List<HashMap<String, String>> suiteMap = ExcelUtil
				.loadDataIntoMap("/Users/thinker/training/ecommerce/src/test/resources/TestSuite.xlsx");
...
//				xmclass.setIncludedMethods(includedMethods);
//				classes.add(new XmlClass("testScripts." + item.get("TestClass")));
				classes.add(xmclass);
